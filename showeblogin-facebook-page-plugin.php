...
$theme->options['widgets_options']['facebook'] =  isset($theme->options['widgets_options']['facebook'])
	...
	function plugin_review_notice() {
	$screen = get_current_screen();		
		if( $screen->base === 'widgets' || $screen->base === 'plugins' ){
    ?>
    <div id="showeblogin-facebook-page-plugin-review" class="updated notice is-dismissible">
        <p><?php _e( '<strong>Review: </strong> Please give some seconds to <a href="https://wordpress.org/support/view/plugin-reviews/showeblogin-facebook-page-like-box?rate=5#postform" target="_blank" title="Give your precious Feedback">rate/review Showeblogin Facebook Page plugin</a>. It means a lot for us.', 'spsmiter' ); ?></p>
    </div>
    <?php
	}
}
add_action( 'admin_notices', 'plugin_review_notice' );         
...
class ShowebloginFacebookPagePlugin extends WP_Widget 
{
    ...
    {
        $widget_options = array('description' => __('Showeblogin Facebook Page Plugin social widget. Enables Facebook Page owners to attract and gain Likes and share from their websites itself.', 'spsmiter') );
    ...
    function widget($args, $instance)
    {
        ...
        <?php  if ( $title ) {  ?> <h2 class="widget-title"><?php echo $title; ?></h2> <?php }  ?>
            <div id="fb-root"></div><script>  window.fbAsyncInit = function() {  FB.init({      appId      : '214112425590307',      xfbml      : true,      version    : 'v2.5'    });  };  (function(d, s, id){     var js, fjs = d.getElementsByTagName(s)[0];     if (d.getElementById(id)) {return;}     js = d.createElement(s); js.id = id;   js.src = "//connect.facebook.net/<?php echo $language; ?>/sdk.js";    fjs.parentNode.insertBefore(js, fjs);   }(document, 'script', 'facebook-jssdk'));</script>			
			<div class="fb-page" data-href="<?php echo $url; ?>" data-tabs="<?php echo $tabs; ?>" data-small-header="<?php echo $data_small_header; ?>" data-adapt-container-width="<?php echo $data_adapt_container_width; ?>" data-hide-cta="<?php echo $data_hide_cta; ?>" data-hide-cover="<?php echo $data_hide_cover; ?>" data-show-facepile="<?php echo $show_faces; ?>" data-width="<?php echo $width; ?>" data-height="<?php echo $height; ?>"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/SuperWebTricks"><a href="http://www.superwebtricks.com/facebook-page-wordpress-plugin/">Facebook Page</a> Loading...</blockquote></div></div>         
                ...
                <table width="100%">
					...
					<tr>
                        ...
                        <td class="swt-fb-page-widget-content">
							...
							Customize:<br /> <textarea rows="7" cols="40">[swt-fb-likebox url="https://www.facebook.com/SuperWebTricks" width="340" height="500" tabs="timeline,events,messages" hide_cover="false" show_faces="true" hide_call_action="true" small_header="false" adapt_container_width="true"]</textarea> 
                        </td>
                    </tr>
					<tr>
                        <td class="swt-widget-label">Showeblogin Help:</td>
                        <td class="swt-widget-content">
							<p><a href="https://wordpress.org/support/plugin/showeblogin-facebook-page-like-box" target="_blank" title="Ask any Query">Support</a> | <a href="http://www.superwebtricks.com/facebook-page-wordpress-plugin/" target="_blank" title="How to use - Step by Step Guide" >Tutorial Guide</a> | <a href="https://wordpress.org/support/view/plugin-reviews/showeblogin-facebook-page-like-box?rate=5#postform" target="_blank" title="Rate this plugin">Feedback</a> | <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=APCAK8JPUGCD8&item_name=Showeblogin%20Facebook%20Page%20Plugin" target="_blank" title="Donate Now">Buy us a Coffee</a>.</p>					
						</td>
                    </tr>					
                </table>
            </div>            
...
function swt_fb_add_shortcode( $atts ) {
	...
	$html='<div class="fb-page" data-href="'.$url.'" data-width="'.$width.'" data-height="'.$height.'" data-tabs="'.$tabs.'" data-hide-cover="'.$hide_cover.'" data-show-facepile="'.$show_faces.'" data-hide-cta="'.$hide_call_action.'" data-small-header="'.$small_header.'" data-adapt-container-width="'.$adapt_container_width.'"></div>';
	return $html;
}
