...
Tags: Facebook, Facebook Badge, Facebook Page Plugin, Facebook Tabs, Like, Like Box, Plugin, Shortcode, Showeblogin, Sidebar, Social, Widget
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=APCAK8JPUGCD8&item_name=Showeblogin%20Facebook%20Page%20Plugin
...
== Description ==
Facebook like box is one of the most important part of social optimization. You can't ignore the power of more than 1.60 billion monthly active users on Facebook. Therefore, it's time to promote your Websites/ Blogs on Facebook and increase your site users on social media.

The **Showeblogin Facebook Page Plugin** is a special version of Facebook Like box created with HTML5 Attribute and designed for *Facebook Pages*. It allows WordPress site owners  like you to promote their Facebook Pages and embed a simple feed of content from a Page into websites by inserting widget in the posts, pages, sidebar or even footer.
...
* Select your preferred language (Default is English) for Facebook Page Like box.
...
> #### Follow Us
> [Blog](http://www.superwebtricks.com/) | [Twitter](https://twitter.com/SuperWebTricks)  | [Google+](https://plus.google.com/+ShowebloginKolkata) | [YouTube](https://www.youtube.com/user/Showeblogin) | [Pinterest](https://www.pinterest.com/sureshprasad/showeblogin/) | [FaceBook](https://www.facebook.com/SuperWebTricks)

== Installation ==
Installation of Facebook Page Plugin to a Website. You may Install **Showeblogin Facebook Page Plugin** either via WordPress.org plugin directory or by uploading files to your server.

= From your WordPress site Dashboard =

**Step-1:** Go to the "Plugins" menu in your WordPress site left sidebar and click "Add New" link.

**Step-2:** Search for "Showeblogin Facebook Page Plugin".

**Step-3:** Click on 'Install Now' button.

**Step-4:** Now, click on 'Activate' link.

**Step-5:** Finally, from widget area of your theme add Facebook Page Plugin and Enjoy!


= By uploading files to Server =

**Step-1:** Download the latest version of Showeblogin Facebook Page Plugin zip file.
...
See [Other Notes](https://wordpress.org/plugins/showeblogin-facebook-page-like-box/other_notes/ "Additional Notes for using Showeblogin Facebook Page Plugin") for detailed instructions on shortcode.

Learn more (and get detailed instructions) in our [Tutorial guide](http://www.superwebtricks.com/blogger-beginner-guide/facebook-page-wordpress-plugin/ "Step by Step guide on how to install Showeblogin Facebook Page Plugin widget in WordPress").

== Frequently Asked Questions ==
= 1. How do I integrate multiple Social Plugins? =
Once you activate this plugin and add like box widget in the sidebar, you can easily integrate any Social Plugin. There is no need to insert the *Facebook SDK for JavaScript* into your web page.

**a) Example of a Like Button**: 
You can paste these code anywhere (Say in sidebar widget) in your site to show Facebook like button.
...
== Use Shortcode ==
Users had requested to make available shortcode to use this plugin. Accordingly, I have made it possible to show your facebook page likebox anywhere in your website through shortcode.

<strong>Default Shortcode: </strong>
Use this default shortcode to show facebook likebox in posts, pages and any other place.
`[swt-fb-likebox]`
...
== Upgrade Notice ==
You should use the latest Showeblogin Facebook Page Plugin.